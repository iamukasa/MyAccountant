...
import com.myaccountant.myaccountant.alice.Alice;
...
public class BrainService extends Service {
    ...
    private void showLoadedNotification(){
        Intent openIntent = new Intent(BrainService.this, MainActivityAI.class);
        ...
        Notification note =
                new NotificationCompat.Builder(BrainService.this)
                        ...
                        .setContentTitle("FAQ Brain")
                        .setContentText("Ask about myaccountant")
